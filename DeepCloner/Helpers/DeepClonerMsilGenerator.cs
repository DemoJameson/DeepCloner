    ...
    internal static class DeepClonerMsilGenerator {
        ...
        internal static object GenerateClonerInternal(Type realType, bool asObject) {
            ...
            var dt = new DynamicMethod(
                "DeepObjectCloner_" + realType.Name + "_" + Interlocked.Increment(ref _methodCounter), methodType,
                new[] {methodType, typeof(DeepCloneState)}, mb, true);
        ...
        private static void GenerateProcessMethod(ILGenerator il, Type type, bool unboxStruct) {
            ...
            if (!type.IsValueType) {
                var constructor = type.GetConstructor(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance, null, Type.EmptyTypes,
                    null);
        ...
        private static void GenerateProcessArrayMethod(ILGenerator il, Type type) {
            ...
            if (rank != 1 || type != elementType.MakeArrayType()) {
                ...
                if (rank == 2 && type == elementType.MakeArrayType()) {
                    ...
                    methodInfo = typeof(DeepClonerGenerator).GetMethod("Clone2DimArrayInternal", BindingFlags.NonPublic | BindingFlags.Static)
            ...
            if (DeepClonerSafeTypes.CanReturnSameObject(elementType)) {
                ...
                il.Emit(
                    OpCodes.Call,
                    typeof(Array).GetMethod("Copy", BindingFlags.Public | BindingFlags.Static, null,
                        new[] {typeof(Array), typeof(Array), typeof(int)}, null));
            } else {
                ...
                if (type.IsValueType) {
                    ...
                    il.Emit(OpCodes.Call,
                        typeof(DeepClonerGenerator).GetMethod("GetClonerForValueType", BindingFlags.NonPublic | BindingFlags.Static)
                            .MakeGenericMethod(elementType));
